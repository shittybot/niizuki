...
export declare class Track {
    ...
    public resolve(niizuki: niizuki): Promise<Track>;
}
...
export declare class Rest extends EventEmitter {
    constructor(niizuki: niizuki, options: RestOptions);
    public niizuki: niizuki;
    public url: String
...
export declare class Player extends EventEmitter {
    constructor(niizuki: niizuki, node: Node, options: PlayerOptions);
    public niizuki: niizuki;
    public node: Node;
...
export declare class niizuki extends EventEmitter {
...
export declare class Node {
    constructor(niizuki: niizuki, node: LavalinkNode, options: NodeOptions);
    public niizuki: niizuki;
